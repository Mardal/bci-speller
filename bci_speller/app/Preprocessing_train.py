...
path = "C:/Users/user/Documents/BCI_Comp_III_Wads_2004/Subject_A_Train.mat"
sampling_rate = 240
...
keys = np.resize(keys, len(keys)*len(keys[0]))
...
#for model use samples[number] and keys[number]
